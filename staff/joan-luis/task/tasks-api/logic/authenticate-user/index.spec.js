...
describe.only('logic - authenticate user', () =>{
    ...
    beforeEach( ()=> {
        ...
        return users.insertOne({name, surname, email, username, password})
            .then (({insertId}) => id = insertId.toString())
    })
...
describe ('when worng credentials', ()=> {
...
it ('should fail on incerrect name, surname, email, password, or expression type and content', ()=> {
